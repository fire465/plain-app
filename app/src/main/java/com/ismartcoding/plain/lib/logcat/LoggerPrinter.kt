...
import com.ismartcoding.plain.lib.logcat.LogCat.ASSERT
import com.ismartcoding.plain.lib.logcat.LogCat.DEBUG
import com.ismartcoding.plain.lib.logcat.LogCat.ERROR
import com.ismartcoding.plain.lib.logcat.LogCat.INFO
import com.ismartcoding.plain.lib.logcat.LogCat.VERBOSE
import com.ismartcoding.plain.lib.logcat.LogCat.WARN
...
internal class LoggerPrinter : Printer {
    ...
    override fun d(`object`: Any?) {
        log(LogCat.DEBUG, null, Utils.toString(`object`))
    }
